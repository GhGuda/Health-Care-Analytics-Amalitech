...
DROP PROCEDURE load_encounter_procedures;
...
CALL load_billing_per_encounter();.patients VALUES 
(1001, 'John', 'Doe','1955-03-15', 'M', 'MRN001'),
(1002, 'Jane', 'Smith', '1962-07-22', 'F', 'MRN002'), 
(1003, 'Robert', 'Johnson', '1948-11-08', 'M', 'MRN003');
...
-- Insert ~150,000 encounters using a stored procedure
DELIMITER $$
CREATE PROCEDURE load_encounters_150k()
BEGIN
    DECLARE i INT DEFAULT 5;
    DECLARE next_encounter_id INT;
...
-- While a query is running, can i run another one without stopping the previous one in mysql database client jdbc vs code estention?